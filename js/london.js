const getLondonData = async function () {
    ...
    const geocodingResponse = await fetch(
        `https://api.openweathermap.org/data/2.5/weather?q=London&appid=7db757d57fb1bb5643015749b12656e1`
    );
    ...
    const insertRow = document.querySelector("#row-london");
    insertRow.innerHTML = `
